...
typedef NS_ENUM(NSUInteger, UIViewCustomBorderDirection) {
    UIViewCustomBorderDirectionTop    = 1 << 0,
    UIViewCustomBorderDirectionLeft   = 1 << 1,
    UIViewCustomBorderDirectionBottom = 1 << 2,
    UIViewCustomBorderDirectionRight  = 1 << 3
};
