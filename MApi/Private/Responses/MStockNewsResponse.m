...
#import "MStockNewsResponse.h"

@implementation MStockNewsResponse
...
- (id)initWithData:(NSData *)data request:(MRequest *)request timestamp:(NSString *)timestamp headers:(NSDictionary *)headers {
    ...
    if (self) {
        ...
        if ([self getJSONObject:&JSONObject withData:data parseClass:NSDictionary.class]) {
            ...
            self.stockNewsDetailItem = [MStockNewsDetailItem itemWithJSONObject:JSONObject];
