...
@implementation NSData (MApi_MKNKBase64)
...
//
+ (NSData *)mapi_dataFromBase64String:(NSString *)aString
{
	NSData *data = [aString dataUsingEncoding:NSASCIIStringEncoding];
	size_t outputLength;
	void *outputBuffer = MApi_NewBase64Decode([data bytes], [data length], &outputLength);
...
//	receiver.
//
- (NSString *)mapi_base64EncodedString
{
	size_t outputLength = 0;
	char *outputBuffer =
		MApi_NewBase64Encode([self bytes], [self length], false, &outputLength);
