...
@interface MApi_MQTTSession(Synchron)

/** connects to the specified MApi_MQTT server synchronously
...
/** closes an MApi_MQTTSession gracefully synchronously
